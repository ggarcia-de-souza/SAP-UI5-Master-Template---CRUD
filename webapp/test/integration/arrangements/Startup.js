sap.ui.define([
	"sap/ui/test/Opa5",
	"numen/talentos/ztlnt2021012/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("numen.talentos.ztlnt2021012.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "numen.talentos.ztlnt2021012",
					async: true
				},
				hash: oOptions.hash,
