						...
						success : function (aEntityData) {
							this.waitFor({
								...
								success : function (oList) {
									...
									oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ScarrSet", {
										Carrid : sCurrentId
									});
			...
			assertions : {
				...
				theListHeaderDisplaysZeroHits : function () {
					return this.waitFor({
						...
						id: "masterPageTitle",
						autoWait: false,
						matchers: new PropertyStrictEquals({name : "text", value : "<ScarrSet> (0)"}),
						success: function () {
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all ScarrSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							this.waitFor({
								id : "masterPageTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name : "text", value : "<ScarrSet> (" + iExpectedLength + ")"}),
								success : function () {
